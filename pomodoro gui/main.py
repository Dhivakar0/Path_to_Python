...
timer_label = Label()
timer_label.config(text="Timer",fg=GREEN,font=(FONT_NAME,50,"bold"),bg=YELLOW,highlightthickness=0)
...
tick_label = Label()
tick_label.config(fg=GREEN,bg=YELLOW,highlightthickness=0,font=(FONT_NAME,15,"bold"))
